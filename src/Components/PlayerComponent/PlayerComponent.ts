...
// Extend the Window interface to include PRCHlsStoryMuted
declare global {
    interface Window {
        PRCHlsStoryMuted: boolean
        PRCHlsStorySubtitle: boolean
        temDMPlayer: any
    }
}
...
export default class PlayerComponent{
    ...
    public onViewablityChange(isVisible: boolean) {
        if (isVisible) {
            ...
            this.player 
            && (
                window["PRCHlsStoryMuted"] !== undefined && (
                    this.player.setMute = window["PRCHlsStoryMuted"]
                ),
                window["PRCHlsStorySubtitle"] !== undefined &&  (
                    this.player.setSubtitles = window["PRCHlsStorySubtitle"]
                ),
            ...
            <div class="story-reel-overlay">
                <div class="story-reel-play-pause-state">
                    <span class="story-reel-pause">
                        ...
                        <span class="prc-hls-story-visually-hidden">${t('play_label')}</span>
                    </span>
                    <span class="story-reel-play">
                        ...
                        <span class="prc-hls-story-visually-hidden">${t('pause_label')}</span>
                    </span>
                </div>
    ...
    private addEvents(){
        ...
        this.player.onLoad = (videoDuration:number)=>{
            ...
            window["PRCHlsStoryMuted"] !== undefined &&  (
                this.player.setMute = window["PRCHlsStoryMuted"] as boolean
            )
            this.player.isSubtitleAvailable
            && (this.subtitleBtn.disabled = false)

            this.player.isSubtitleAvailable 
            && (window["PRCHlsStorySubtitle"] = this.player.isSubtitleActive)
        ...
        this.player.onVideoStart = ()=>{
            ...
            this.container.closest(".prc-hls-story")?.classList.contains("container-small")
        ...
        this.player.onSubtitleToggle = (flag:boolean)=>{
            window["PRCHlsStorySubtitle"] = flag
        ...
        this.player.onMute = (isMuted: boolean)=>{
            ...
            window["PRCHlsStoryMuted"] = isMuted
        }
        // on player play 
        ...
        this.shareBtn.addEventListener('click', async(e)=>{
            ...
            if(!this.container.closest(".prc-hls-story")?.classList.contains("container-small")){
                try {
