...
export default class FullPageComponent {
    ...
    public open(index: number){
        ...
        document.body.classList.add("prc-hls-story-fullpage")
    ...
    private setupForDynamicSlide(){
        if(this.addDynamicSlide && this.refId){
            (window as any)["PRCHlsStory"][this.refId].lockSlide = this.onAdUIChange.bind(this)
        }
    }
    private renderHtml() {
        this.container.innerHTML = `<div class="daily-carousel story-fullpage-carousel" role="region" aria-label="${t('fullpage_label')}">
            ...
            <div
                class="prc-hls-story-announcer prc-hls-story-visually-hidden"
                role="status"
                aria-live="polite"
                aria-atomic="true"
            ></div>
        ...
        // selecting elements
        this.storyAnnouncer = this.container.querySelector(".prc-hls-story-announcer")!
    ...
    private onAdUIChange (isAdPlaying: boolean, el?: HTMLElement) {
        ...
        this.closeBtn.classList.toggle("prc-hls-story-hidden", isAdPlaying)
    ...
    private closeFullPage () {
        ...
        document.body.classList.remove("prc-hls-story-fullpage")
