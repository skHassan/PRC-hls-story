...
export function getParams(container: HTMLElement): any {
  ...
  const settings = refId && (window as any)["PRCHlsStory"] && (window as any)["PRCHlsStory"][refId]|| {}
