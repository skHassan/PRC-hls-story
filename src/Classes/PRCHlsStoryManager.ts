...
import '../Styles/PRCHlsStory.scss'
...
export default class PRCHlsStoryManager {
  ...
  constructor(container: HTMLElement) {
    ...
    if(!this.params.playlistId){
      console.error(t("playlistId is required for PRCHlsStoryManager"))
      return
    }
    if(!this.params.apiUrl){
      console.error(t("apiUrl is required for PRCHlsStoryManager"))
      return
    }
